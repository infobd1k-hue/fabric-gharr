...
- **Settings tab**: Shows the signed-in Gmail (tap to copy), JSON backup (share-sheet on mobile / clipboard on web), JSON restore (file picker), and "use a different email" sign-out.
